 ...
 * on handsets.
 */
class StarterItemDetailFragment : Fragment(), RequestListener<Drawable> {
    ...
    private lateinit var starterItem: StartersItem

    private var _binding: FragmentStarterItemDetailBinding? = null
...
//            item = PlaceholderContent.ITEM_MAP[dragData]
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStarterItemDetailBinding.inflate(inflater, container, false)
    ...
    private fun updateContent() {
        itemNameTv.text = starterItem.title
        itemBodyText1Tv.text = starterItem.description
        context?.let {
            Picasso.get()
                .load(starterItem.heroImg)
                .resize(200, 160)
                .centerCrop()
                .into(itemImage)
        }
